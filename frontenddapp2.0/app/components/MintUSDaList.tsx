...
function ListItemMetric({
  ...
  return (
    <div className="flex md:flex-col justify-between md:justify-between w-full md:h-full text-left md:text-center items-start md:items-center mt-4 md:mt-0 ">
      <div className="font-plex-grotesk text-grayLight font-medium text-lg w-[150px] md:w-auto">
        {label}
      </div>
      <div
...
function SingleListItemImage({
  ...
  return (
    <div className="flex flex-col items-start justify-between h-[160px] min-w-[120px]">
  ...
  return (
    ...
    >
      <div className="flex lg:w-1/2 flex-col md:flex-row w-full">
        ...
        <div className="flex flex-grow flex-col md:flex-row w-full max-w-screen-md h-[150px]">
