export const hegicEth = [
  {
    inputs: [
      ...
      { internalType: "contract HegicETHPool", name: "_pool", type: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IHegicStakingETH", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address payable", name: "newHolder", type: "address" },
    ],
    name: "transfer",
    outputs: [],
    stateMutability: "nonpayable",
