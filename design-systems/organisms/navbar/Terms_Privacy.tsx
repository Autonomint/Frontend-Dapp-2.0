          ...
          <div className="mb-4">
            ...
            <ul className="pl-6 list-disc">
              ...
              <li>
                ...
                Autonomint Technologies Pvt. Ltd., 133, Main Bazaar, Garhi
                Ahata, Pathankot, Gurdaspur - 145001.
              </li>
              <li>
              ...
              <li>
                <span className="font-bold">Country</span> refers to: Punjab,
                India.
              </li>
              <li>
              ...
              <li>
                <span className="font-bold">Website</span> refers to Autonomint,
                accessible from https://www.autonomint.com/
              </li>
              <li>
