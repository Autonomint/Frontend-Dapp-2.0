...
function MintUSDAHoverElement({ feesList }: { feesList: FeeDetail[] }) {
  ...
  return (
    <div
      ...
      className="flex flex-col animateMint border-x border-y border-[1px] overflow-y-hidden  border-grayLight gap-2 lg:gap-4 2xl:gap-2 h-full bg-gradient-to-b from-[#E5F3FF] to-[#FFFDE4] dark:bg-custom-gradient-to-top  lg:p-6 relative"
    >
      <div className="p-3">
        ...
        <div className="flex mt-4 flex-col xs:flex-row align-top xl:gap-20 gap-3 sm:gap-6 md:gap-12 sm:ml-4 lg:ml-0">
          <div>
        ...
        <div className="flex w-full  sm:mt-[-10px] ml-2 items-center justify-start sm:justify-end gap-2 xl:mb-24 xl:mt-4">
          ...
          <div className="flex relative mt-2 items-center justify-start pr-20 sm:pr-16 md:pr-20 lg:pr-24 xl:pr-28 ">
            ...
            <div className="flex absolute z-[8] w-[20px] h-[20px] sm:w-[25px] sm:h-[25px] xl:w-[35px] xl:h-[35px] left-[13%] flex-col items-center justify-center gap-2">
              <Tooltip>
                <TooltipTrigger asChild>
                  <Image
                    className="w-full h-full"
            ...
            <div className="flex absolute w-[20px] h-[20px] sm:w-[25px] sm:h-[25px] xl:w-[35px] xl:h-[35px] z-[7] left-[24%] flex-col items-center justify-center gap-2">
              <Tooltip>
                <TooltipTrigger asChild>
                  <Image
                    className="w-full h-full"
            ...
            <div className="flex absolute w-[20px] h-[20px] sm:w-[25px] sm:h-[25px] xl:w-[35px] xl:h-[35px] z-[6] left-[35%] flex-col items-center justify-center gap-2">
              <Tooltip>
                <TooltipTrigger asChild>
                  <Image
                    className="w-full h-full"
