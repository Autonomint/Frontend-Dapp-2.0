      ...
      <div>
        <div className="grid md:grid-cols-2 gap-6 md:gap-10 grid-cols-1">
          ...
          {strategies.map((strategy) => (
            <div
              key={strategy.id}
              className="border-[1px] border-gray-200 rounded-[12px] bg-gray-100 dark:border-[#333333] dark:bg-[#121212] shadow-md"
            >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 justify-start mt-2 flex-wrap">
                        {strategy.rewards.map((reward) => (
                          <div
                            key={reward.token}
                            className="text-sm flex gap-1 items-center justify-center font-medium font-plex-grotesk text-center w-fit text-black border-[1px] bg-white border-indigo-600 rounded-[12px] px-1 py-[2px]"
                          >
                            <Image
                              src={
                                reward.token === "ABOND"
                      ...
                      {strategy.monthlyYield.map((yieldData, index) => (
                        ...
                        >
                          ...
                          <div className="flex gap-1 items-center">
                            ...
                            {yieldData.amount} {yieldData.percentage}
                          </div>
                        </div>
                      ))}
                    </div>
