        ...
        <div className="mt-16 space-y-16">
          ...
          <section className="max-w-3xl mx-auto text-left">
            ...
            <p className="text-grayLight  text-lg">
              Whether you&apos;re a DeFi native, a cautious first-timer, an
              option derivative trader or a hedge fund looking for a cheaper
              hedge on crypto assets, USDA+ is designed to provide you with a
              safe stablecoin experience and get you access to unexplored
              derivative strategies without the complex overhead.
            </p>
          </section>
